        ...
        <section className='container mx-auto'>
            ...
            <div className="bg-black py-10 px-20 text-white ">
                <p className='text-[14px] tracking-widest '>We specializes in all types of catering. Ranging from the basic food pick up for at least 30 people to 100% custom <br /> catering. We are equipped with the very best equipments for outdoors and our massive production line enables us to <br /> produce food for up to 2000 people.
                    ...
                    We have maintained the flexibility and level of personal service, which it prides itself on. We have entertained thousands <br /> of guests through evocative aromas and flavours of personalised hand manufactured cuisine all over. We present an <br /> extensive and innovative menu. that offers a truly unsurpassed range of authentic and innovative Indian vegetarian <br /> dishes, drawing from the cuisine’s of various regions of India. If you require a dish that is not listed on our menu, please <br /> do enquire and we will be happy to accommodate your requirements. We cater for clients with specific dietary <br /> requirements and can adapt our recipes to your individual tastes and preferences.</p>
            </div>
        </section>
    )
}
